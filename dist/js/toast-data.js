...
$(document).ready(function() {
	...
	$.toast({
		heading: 'Well done!',
		text: '<p>KAMU have successfully completed level 1.</p><button class="btn btn-primary btn-sm mt-10">Play again</button>',
		position: 'top-right',
		loaderBg:'#7a5449',
	...
	$('.tst7').on('click',function(e){
		...
		$.toast({
           heading: 'Well done!',
			text: '<p>AKU7 have successfully completed level 1.</p><button class="btn btn-primary btn-sm mt-10">Play again</button>',
			position: 'bottom-left',
			loaderBg:'#7a5449',
			class: 'jq-toast-primary',
			hideAfter: 3500, 
